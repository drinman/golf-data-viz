    ...
    <main className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="mt-10 text-center">
        ...
        <button
          ...
          className="inline-flex min-h-11 items-center justify-center rounded-lg bg-brand-800 px-6 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-brand-700 hover:shadow-md active:translate-y-0"
        >
