...
export function LastRoundBanner({
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex items-baseline gap-2 text-sm text-neutral-600">
      ...
      <div className="mt-3 flex items-center gap-3">
        ...
        <button
          type="button"
          onClick={onDismiss}
          className="inline-flex min-h-11 items-center text-sm text-neutral-500 transition-colors hover:text-neutral-600"
        >
          Dismiss
        </button>
      </div>
