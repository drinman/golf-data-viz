    ...
    >
      ...
      <div className="mt-3 flex items-center gap-3">
        <button
          type="button"
          onClick={onRestore}
          className="rounded-lg bg-brand-800 px-4 py-2 text-sm font-medium text-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0"
        >
          View Results
        </button>
        <button
