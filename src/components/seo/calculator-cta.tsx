  ...
  return (
    <div className="rounded-lg border border-brand-100 bg-brand-50 px-5 py-4">
      ...
      <Link
        ...
        className="mt-3 inline-flex items-center rounded-lg bg-brand-800 px-5 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-brand-700 hover:shadow-md active:translate-y-0"
      >
